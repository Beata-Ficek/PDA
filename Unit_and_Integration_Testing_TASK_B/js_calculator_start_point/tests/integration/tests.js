...
describe('calculator functionality', function() {
  ...
  element(by.css('#number4')).click();
  element(by.css('#number2')).click();
  expect(running_total.getAttribute('value')).to.eventually.equal('17442');
});
  ...
  it('should work to update the display with the result of the operation /', function () {
    ...
    it('should be able to chain multiple operations together', function () {
      ...
      it('should work as expected for a range of numbers - decimals', function () {
        ...
        element(by.css('#number5')).click();
        element(by.css('#operator_equals')).click();
        expect(running_total.getAttribute('value')).to.eventually.equal('275.8');
      });
      ...
      it ('should work as expected if a number is divided by zero', function (){
        element(by.css('#number2')).click();
        element(by.css('#operator_divide')).click();
